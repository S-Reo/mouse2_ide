...
//
//	//上限はマクロで設定
//	if(left > 8000*0.6) left = 8000*0.8;
//	if(right > 8000*0.6) right = 8000*0.8;
//
//	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, left); //tim2ch4が左
//	  __HAL_TIM_SET_COMPARE(&htim5, TIM_CHANNEL_1, right); //tim5ch2が右
//}
